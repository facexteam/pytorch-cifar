...
python train_large_margin_zyf.py --cifar-dir ./data \
    ...
    --save-dir checkpoints-res20-cifar-coslr-200ep-spav3-s${s}-coslr-${epoch}ep-m${m}-n${n}-b${b}
    # --save-dir checkpoints-res20-cifar-coslr-200ep-spav3-s32-coslr-200-m0.35-test
    # --no-progress-bar \
    # --resume \
